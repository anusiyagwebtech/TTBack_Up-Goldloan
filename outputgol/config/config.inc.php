...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=goldloan;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/goldloan/';
    $fsitename = 'http://localhost/ttbilling/goldloan/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOT', $fsitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/goldloan/";
    ...
    $db = new PDO('mysql:host=localhost;dbname=goldloan;charset=utf8mb4', 'goldloan', 'goldloan');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "goldloan", "goldloan", "goldloan");
    $sitename = "https://ttbilling.in/goldloan/";
    $site = 'https://ttbilling.in/goldloan/';
    $fsitename = 'https://ttbilling.in/goldloan/';
