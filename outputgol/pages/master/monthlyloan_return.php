...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Do you want to delete the Monthly Loan(s)"))
            {
                return true;
            }
            else
...
<style type="text/css">
    .row { margin:0;}
    #normalexamples tbody tr td:nth-child(8),tbody tr td:nth-child(7) {
        text-align:center;
       /* font-size: 19px;*/
    }
    .colorchange{
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Master
            <small>List of Fully Loan Return(s)</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
            <li><a href="#"><i class="fa fa-asterisk"></i>Master(s)</a></li>
            <li class="active"><a href="#"><i class="fa fa-circle-o"></i>Fully Loan Return</a></li>            
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?php echo $sitename; ?>master/addmonthly_loan.htm">Add New Fully Return</a></h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <?php echo $msg; ?>
                        ...
                        <table id="normalexamples" class="table table-bordered table-striped">
                            <thead>
                                <tr align="center" style="font-size:15px;">
                                    ...
                                    <th style="width:15%">Pawned Date</th>
                                    <th style="width:15%">Return Date</th>
                                    <th style="width:15%">Customer ID</th>
                                    <th style="width:10%">Receipt No</th>
                                    <th style="width:10%">Status</th>
                                    <th data-sortable="false" align="center" style="text-align: center; padding-right:0; padding-left: 0; width: 15%;">Edit</th>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editmonthly_loan.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        "searching": true,
	"ordering":false,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=fullyreturntable"
    });
</script>