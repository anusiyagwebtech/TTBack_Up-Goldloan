...
if (isset($_REQUEST['submit'])) {
    ...
    for ($i = 0; $i < count($_FILES['object_image']['name']); $i++) {
        ...
        if ($_FILES['object_image']['name'][$i]) {
            ...
            move_uploaded_file($tmp, '../../img/bank/' . $object_image);
 ...
 $object_imagess1=implode(',',$object_images);
    ...
    $msg = addbankstatus($object_imagess1,$receiptno,$loanno,$name,$cus_amount, $bankname, $dateofpawn, $object1, $quantity1, $totalquantity, $weight, $amount, $interestpercent, $interest, $month, $status, $totalamount, $returndate,$no_of_days, $ip, $getid);
}
                                        ...
                                        <table width="80%" class="table table-bordered" id="task_table" cellpadding="0"  cellspacing="0">
                                            ...
                                            <tbody>
                                                <tr id="firsttasktr" style="display:none;">
                                                    ...
                                                    <td style="border: 1px solid #f4f4f4;"><input type="number" style="text-align: right;" name="quantity[]" id="quantity[]" class="form-control" value="" onkeyup="quantitycalculation(this.value)"/><input type="hidden" name="qtyhidden" id="qtyhidden" value="" /></td>
                                                        <td>
<input type="hidden" style="text-align: right;" name="eobject_image[]" id="eobject_image[]" class="form-control" />
                                                        <input type="file" style="text-align: right;" name="object_image[]" id="object_image[]" class="form-control" /></td>
                                                </tr>
                                                <?php
                                                $b = 1;
...
<input type="hidden" style="text-align: right;" name="eobject_image[]" id="eobject_image[]" class="form-control" value="<?php echo $object1list['object_image']; ?>"/>

    <img src="../../img/bank/<?php echo $object1list['object_image']; ?>" height="50"></td>
 ...
 <div class="col-md-4">
                            ...
                            <input type="text" id="interestpercent"  name="interestpercent" placeholder="Enter Interest Percent" class="form-control" value="<?php echo stripslashes(getbankstatus('interestpercent', $_REQUEST['bid'])); ?>" onkeyup="interest_calculation()"/>
                        </div>
                        <div class="col-md-4">
