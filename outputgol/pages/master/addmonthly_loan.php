...
$msg = addfullyreturn($gramamt,$eligible_gram,$objects,$customerid,$loanid,$customeridname,$currentdate,$date,$name, $mobileno,$objectname, $netweight, $amount, $interest, $status, $interest_amount,$monthly_payment,$paid_principal_amt,$balance_principal_amt,$pending_due, $ip, $getid);
}
    ...
    <section class="content-header">
        <h1>
            ...
            <small><?php
                ...
                ?>Fully Loan Return</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $sitename; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="#"><i class="fa fa-asterisk"></i> Master(s)</a></li>            
            <li><a href="<?php echo $sitename; ?>master/monthlyloan_return.htm"><i class="fa fa-circle-o"></i> Fully Loan Return</a></li>
            <li class="active"><?php
                if ($_REQUEST['cid'] != '') {
                    echo 'Edit';
                } else {
    ...
    $gold_rate = $smstemplate['gold_rate'];
                            ...
                            <select name="customerid" id="customerid" class="form-control select2" required="required" onchange="loan(this.value)">
                                ...
                                <?php } ?>               
                                    ...
                                    <!-- <input type="text" name="customerid" id="customerid" class="form-control" placeholder="Enter the Customer ID" value="<?php echo getfullyretun("customerid", $_REQUEST['cid']); ?>" /> -->
                        </div> 
                        <div class="col-md-4" >
                            ...
                            <select name="loanid" id="loanid" class="form-control" required="required" onchange="return_1(this.value)">
                                ...
                                if (isset($_REQUEST['cid'])) {
                                    ...
                                    $customerlist = pFETCH("SELECT * FROM `loan` WHERE `status`=? AND `cusid` =? ", '1', getfullyretun('customer_id', $_REQUEST['cid']));
                                    while ($objectfetch = $customerlist->fetch(PDO::FETCH_ASSOC)) {
                                        echo $objectfetch['receipt_no'];
                                        ?>
                                        <option value="<?php echo $objectfetch['id']; ?>" <?php if (getfullyretun('loanid', $_REQUEST['cid']) == $objectfetch['id']) { ?> selected <?php } ?>><?php echo $objectfetch['receipt_no']; ?></option>
                                        <?php
                                    }
                                }
                                ?>           
                            </select>
                                    <!-- <input type="text" name="receiptno" id="receiptno" placeholder="Enter the Receipt Number"  class="form-control" value="<?php echo getfullyretun("receiptno", $_REQUEST['cid']); ?>" /> -->
                        </div> 
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right usedatepicker" name="currentdate" id="currentdate" required="required"  value="<?php if($_REQUEST['cid']!='') { echo getfullyretun('currentdate',$_REQUEST['cid']); } else { echo date('d-m-Y'); }
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group date">
                                    ...
                                    if (isset($_REQUEST['cid'])) {
                                        echo date('d-m-Y', strtotime(getfullyretun("date", $_REQUEST['cid'])));
                                    } else {
                                        echo date('d-m-Y');
                                    }
                                    ?>" >
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" readonly name="name" id="name" placeholder="Enter Name" class="form-control" value="<?php echo stripslashes(getfullyretun("name", $_REQUEST['cid'])); ?>" />
                            </div>
                            <div class="col-md-4">
                                <label>Mobile Number <span style="color:#FF0000;">*</span></label>
                                <input type="text" readonly name="mobileno" id="mobileno" placeholder="Enter Mobile Number" class="form-control" value="<?php echo stripslashes(getfullyretun("mobileno", $_REQUEST['cid'])); ?>" />
                            </div>
...
//            echo $cutomerlist['id'].'<br>';
                ...
                $objectlist->execute(array('1',getfullyretun("loanid", $_REQUEST['cid'])));
                ...
                ?>  </textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" readonly name="netweight" id="netweight" placeholder="Enter Net Weight" class="form-control" value="<?php echo stripslashes(getfullyretun("netweight", $_REQUEST['cid'])); ?>" />
                            </div>
                            <div class="col-md-4">
                                <label>Amount <span style="color:#FF0000;"></span></label>
                                <input type="text" readonly name="amount" id="amount" placeholder="Enter Amount" class="form-control" value="<?php echo stripslashes(getfullyretun("amount", $_REQUEST['cid'])); ?>"  />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="interest"  name="interest" placeholder="Enter Interest Amount" readonly class="form-control" value="<?php echo stripslashes(getfullyretun("interest", $_REQUEST['cid'])); ?>" onchange="interestvalue()"/>
...
<option value="3" <?php
                            ...
                            <!-- <div class="col-md-4">
                                ...
                                <input type="text" id="pawndays"  name="pawndays" class="form-control" value="<?php echo stripslashes(getfullyretun('pawndays', $_REQUEST['cid'])); ?>" />
                            </div> -->
                        </div> 
                      </div></div>
                        <br>
                ...
                <label>Pending Loan Amount <span style="color:#FF0000;">*</span></label>
                 <input type="text" name="pending_loan_amount" id="pending_loan_amount1" value="<?php echo getfullyretun("pending_loan_amt", $_REQUEST['cid']); ?>" class="form-control">
            </div>
            <div class="col-md-4">
                <label>Interest Amount <span style="color:#FF0000;">*</span></label>
                <input type="text" id="interest_amount1"  name="interest_amount" class="form-control" value="<?php echo getfullyretun("interest_amount", $_REQUEST['cid']); ?>" />

            </div>
            <div class="col-md-4">
                <label>Principal Loan Amount<span style="color:#FF0000;">*</span></label>
                <input type="text" required="required" id="monthly_payment1" name="monthly_payment" class="form-control" value="<?php echo getfullyretun("monthly_payment", $_REQUEST['cid']); ?>"/>
            </div>
        ...
        <div class="row">
              <div class="col-md-4">
                ...
                <input type="text" readonly id="paid_principal_amt1"  name="paid_principal_amt" class="form-control" value="<?php echo getfullyretun("paid_principal_amt", $_REQUEST['cid']); ?>"/>
            </div>
             <div class="col-md-4">
                <label>Eligible Gram to Return<span style="color:#FF0000;">*</span></label>
                <input type="text" required="required" id="eligible_gram1"  name="eligible_gram" class="form-control" value="<?php echo getfullyretun("eligible_gram", $_REQUEST['cid']); ?>" />
            </div>
            <div class="col-md-4">
                <label>Balance Principal Amount<span style="color:#FF0000;">*</span></label>
                <input type="text" required="required" id="balance_principal_amt1"  name="balance_principal_amt" class="form-control" value="<?php echo getfullyretun("balance_principal_amt", $_REQUEST['cid']); ?>" />
            </div>
...
$(document).on('keyup', '#monthly_payment1', function (e){
 ...
 $('#monthly_payment1').click(function () {
    ...
    function return_1(a) {
        ...
        $.ajax({
            url: "<?php echo $sitename; ?>pages/master/monthly_ajax.php",
            data: {loanid: a},
