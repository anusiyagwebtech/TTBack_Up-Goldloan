...
$msg = addobject($objectname,$objectname_tamil,$status, $getid);
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>master/object.htm"><i class="fa fa-circle-o"></i> Object</a></li>
            <li class="active"><?php
                if ($_REQUEST['id'] != '') {
                    echo 'Edit';
                } else {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                         ...
                         <?php //$purid = get_bill_settings('prefix', '2') . str_pad(get_bill_settings('current_value', '2'), get_bill_settings('format', '1'), '0', STR_PAD_LEFT);
                                    ?>
                                    <input type="text" name="objectname" id="objectname" class="form-control" placeholder="Enter the Object name" value="<?php echo getobject('objectname',$_REQUEST['id']); ?>" />
                        </div>
                        <div class="col-md-4">
                             <label>Object name(தமிழ்)<span style="color:#FF0000;">*</span></label>
                         <?php //$purid = get_bill_settings('prefix', '2') . str_pad(get_bill_settings('current_value', '2'), get_bill_settings('format', '1'), '0', STR_PAD_LEFT);
                                    ?>
                                    <input type="text" name="objectname_tamil" id="objectname" class="form-control" placeholder="Enter the Object name(தமிழ்)" value="<?php echo getobject('objectname_tamil',$_REQUEST['id']); ?>" />
                        </div>
                        <div class="col-md-4">
                            <label>Status</label>
