                    ...
                    <div id="receiptdetails">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" readonly id="interestpercent"  name="interestpercent" placeholder="Enter Interest Percent" class="form-control" value="<?php echo stripslashes(getreturn("interestpercent", $_REQUEST['cid'])); ?>" />
                            </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label>Pay Amount <span style="color:#FF0000;">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <label>Balance Amount To Pay<span style="color:#FF0000;">*</span></label>
                                    <input type="text" readonly id="finalpay"  name="finalpay" class="form-control" value="<?php echo stripslashes(getreturn('finalpay', $_REQUEST['cid'])); ?>" />
                                </div> </div>
                            </div>
                        </div>
                    </div>
