...
$msg = addreturn($customerid,$loanid,$customeridname,$currentdate,$date,$name, $mobileno,$objectname, $netweight, $amount, $interest, $status, $interest_amount,$monthly_payment,$paid_principal_amt,$balance_principal_amt,$pending_due, $ip, $getid);
}
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $sitename; ?>master/monthly_intrst_paid.htm"><i class="fa fa-circle-o"></i> Monthly Interest</a></li>
            <li class="active"><?php
                if ($_REQUEST['cid'] != '') {
                    echo 'Edit';
                } else {
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="customerid" id="customerid" class="form-control select2" required="required" onchange="loan(this.value)">
                                ...
                                while ($customerfetch = $customer->fetch(PDO::FETCH_ASSOC)) {
                                    ?>
                                    <option value="<?php echo $customerfetch['id']; ?>" <?php if (getreturn('customer_id', $_REQUEST['cid']) == $customerfetch['id']) { ?> selected <?php } ?>><?php
                        ...
                        <div class="col-md-4" >
                            ...
                            <select name="loanid" id="loanid" class="form-control" required="required" onchange="return_1(this.value)">
                                ...
                                if (isset($_REQUEST['cid'])) {
                                    ...
                                    $customerlist = pFETCH("SELECT * FROM `loan` WHERE `status`=? AND `cusid` =? ", '1', getreturn('customer_id', $_REQUEST['cid']));
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right usedatepicker" name="currentdate" id="currentdate" required="required"  value="<?php if($_REQUEST['cid']!='') { echo getreturn('currentdate',$_REQUEST['cid']); } else { echo date('d-m-Y'); }
                    ...
                    <div id="receiptdetails">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" readonly name="name" id="name" placeholder="Enter Name" class="form-control" value="<?php echo stripslashes(getreturn("name", $_REQUEST['cid'])); ?>" />
                            </div>
                            <div class="col-md-4">
                                <label>Mobile Number <span style="color:#FF0000;">*</span></label>
                                <input type="text" readonly name="mobileno" id="mobileno" placeholder="Enter Mobile Number" class="form-control" value="<?php echo stripslashes(getreturn("mobileno", $_REQUEST['cid'])); ?>" />
                            </div>
...
//            echo $cutomerlist['id'].'<br>';
                ...
                $objectlist->execute(array('1',getreturn("loanid", $_REQUEST['cid'])));
                ...
                ?>  </textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" readonly name="netweight" id="netweight" placeholder="Enter Net Weight" class="form-control" value="<?php echo stripslashes(getreturn("netweight", $_REQUEST['cid'])); ?>" />
                            </div>
                            <div class="col-md-4">
                                <label>Amount <span style="color:#FF0000;"></span></label>
                                <input type="text" readonly name="amount" id="amount" placeholder="Enter Amount" class="form-control" value="<?php echo stripslashes(getreturn("amount", $_REQUEST['cid'])); ?>"  />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="interest"  name="interest" placeholder="Enter Interest Amount" readonly class="form-control" value="<?php echo stripslashes(getreturn("interest", $_REQUEST['cid'])); ?>" onchange="interestvalue()"/>
                ...
                <input type="text" name="pending_loan_amount" id="pending_loan_amount1" value="<?php echo getreturn("pending_loan_amt", $_REQUEST['cid']); ?>" class="form-control">
            </div>
            <div class="col-md-4">
                <label>Interest Amount <span style="color:#FF0000;">*</span></label>
                <input type="text" required="required" id="interest_amount1"  name="interest_amount" class="form-control" value="<?php echo getreturn("interest_amount", $_REQUEST['cid']); ?>" />
               
            </div>
            <div class="col-md-4">
                <label>Monthly Interest Payment <span style="color:#FF0000;">*</span></label>
                <input type="text" required="required" id="monthly_payment1" name="monthly_payment" class="form-control" value="<?php echo getreturn("monthly_payment", $_REQUEST['cid']); ?>"/>
            </div>
        ...
        <div class="row">
             <div class="col-md-4">
                ...
                <input type="text" readonly id="paid_principal_amt1"  name="paid_principal_amt" class="form-control" value="<?php echo getreturn("paid_principal_amt", $_REQUEST['cid']); ?>"/>
            </div>
            <div class="col-md-4">
                <label>Balance Principal Amount<span style="color:#FF0000;">*</span></label>
                <input type="text" required="required" id="balance_principal_amt1"  name="balance_principal_amt" class="form-control" value="<?php echo getreturn("balance_principal_amt", $_REQUEST['cid']); ?>" />
            </div>
