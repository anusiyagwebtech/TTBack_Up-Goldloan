...
<!--                                                    <td style="border: 1px solid #f4f4f4;"><div class="row"><div class="col-md-6"><input class="form-control spinner" <?php if (getobjectdetail('object_image', $_REQUEST['lid']) == '') { ?>  <?php } ?> name="object_image[]" type="file"></div></div> </td>-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label>Rs. <?php echo stripslashes(getloan("amount", $_REQUEST['lid'])); ?></label>
                        </div>
                    </div> <br>
                    <!-- <div class="panel panel-info">
                   ...
                   <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label>Rs. <?php echo stripslashes(getloan('interest', $_REQUEST['lid'])); ?></label>
                        </div>
                    </div>
                    </br>
                    <div class="row">
