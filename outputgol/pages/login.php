...
<html lang="en-IN">
    <head>
        <meta charset="UTF-8">
        <title>INDIRA GOLD LOANS | Login</title>
    ...
    <body class="login-page  ">
        <div class="login-box ">
            <div class="login-logo">
               <!--  <img src="<?php echo $sitename; ?>images/elogo.jpg"/> -->
                <a href="#"><h3>INDIRA GOLD LOANS<!-- <img src="<?php echo $sitename; ?>pages/profile/image/1532344513.png" /> --></h3></a>
            </div><!-- /.login-logo -->
