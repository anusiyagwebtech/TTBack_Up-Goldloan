...
if (isset($_REQUEST['submit'])) {    
    ...
    if ($password == $cpassword) {
        $msg = addprofile($gold_rate,$tax,$title, $firstname, $lastname, $image, $cmpnyname, $recoveryemail, $phonenumber,$mail_option,  $caddress, $abn, $ip,$bank_name,$branch_name,$account_name,$account_no,$ifsc_code,$swift_code,$branch_address, $_SESSION['UID']);
    } else {
                        ...
                        <div class="panel-body">
                          ...
                          <!--   <div class="row">
                                   <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter the current gold rate" name="gold_rate" id="lastname"  value="<?php echo getprofile('gold_rate', $_SESSION['UID']); ?>" />
                                </div>
                            </div> -->
                        </div>
                    </div>
