    ...
    <body class="skin-blue sidebar-mini skin-blue sidebar-mini <?php echo $collapse; ?>" onload="startTime();">
        <div class="wrapper">
            <header class="main-header">
                <!-- Logo -->
                <a href="<?php echo $sitename; ?>" class="logo" style="background-color: #c5b276;">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><b>IL</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>INDIRA GOLD LOANS</b></span>
                </a>
                <!-- Header Navbar: style can be found in header.less -->
                <nav class="navbar navbar-static-top" role="navigation" style="background-color: #c5b276;">
