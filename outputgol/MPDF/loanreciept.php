...
<table width='100%'>
<tr>
<td><img src=".$sitename."images/elogo.jpg></td>
<td align='center'><div align='center' style='color:#000;font-size:30px;'>INDIRA GOLD LOANS<br>இந்திரா தங்க நகை கடன்</div>
<div align='center' style='color:#425C36;font-size:20px;'>
1/45, kancharampettai, Kavanur Village,<br> Madurai 625014<br>
</div></td>
<td><img src=".$sitename."images/tlogo.jpg></td>
</tr>
</table>
...
<table width='50%'>
<tr>
<td width='10%'>Loan amount Rs.</td>
<td width='20%'>".number_format($loandetails['amount'],2)."</td>
</tr>
<tr>
<td width='10%'>கடன் தொகை Rs.</td>
<td width='20%'>".number_format($loandetails['amount'],2)."</td>
</tr>
</table>
</div>
